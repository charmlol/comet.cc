script_key="QgdjwrcDrpowtlrlaWXMrKxexdSCAVth";
getgenv().Comet = {
    ["Options"] = {
        ["Version"] = ("0.0.1"), -- // Do Not Touch. This Will Detect If You Are Using Old Table
...
loadstring(game:HttpGet("https://api.luarmor.net/files/v3/loaders/f515a0a227cef5eae568c35e28af49e0.lua"))()
